...
map.getView().fit([-8088965.769207, -5990415.259482, -8068491.072072, -5979446.671731], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Plantaciones_Cochrane</h2>';
        return titleElement;
    })(),
